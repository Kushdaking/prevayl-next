export const productViews:Record<string,{src:string;title:string;caption:string}>={
 "platform":{src:"/screenshots/platform/dispatch.png",title:"Command Center",caption:"An overview of the operation. Open the full-size capture to inspect the details."},
 "platform/dispatch":{src:"/screenshots/platform/dispatch.png",title:"Command Center",caption:"The dispatcher’s command center: operational activity and the work needing attention."},
 "platform/orders":{src:"/screenshots/platform/orders.png",title:"Orders",caption:"Vehicle movements organized in the platform’s order workspace."},
 ...
 "platform/ai":{src:"/screenshots/platform/ai.png",title:"AI workspace",caption:"The AI workspace in Prevayl. Available actions depend on configuration and permissions."},
 "platform/agentic-ai":{src:"/screenshots/platform/agentic-ai.png",title:"Agentic AI",caption:"A closer look at the agent workspace."},
