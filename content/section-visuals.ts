...
"platform/dispatch":["board","match","inspection","route"],"platform/orders":["board","board","board"],"platform/accounting":["ledger"],"platform/carriers":["board","route","connections","ledger"],"platform/dealer-portal":["portal"],"platform/compliance":["documents"],"platform/ai":["pricing","match","automation"],"platform/business-intelligence":["trend","forecast","board","trend"],"platform/load-optimizer":["capacity","capacity","board"],"platform/route-optimizer":["route"],"platform/flolens":["automation"],"solutions":["connections","route"],"solutions/brokers":["connections","board","pricing","documents","ledger"],"solutions/carriers":["board","route","connections","ledger","board"],"solutions/dealers":["portal","message"],"solutions/wholesale":["connections","board","route","inspection"],"customers":["team","onboarding","message"],"about":["team","board","principles","route"],"about/company":["onboarding","principles","inspection"],"about/leadership":["team","principles"],"about/careers":["team","principles","message"],"resources":["library"],"resources/security":["permissions","connections","pin","message"],"resources/blog":["library"],
