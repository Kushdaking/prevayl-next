...
export const solutionsCarriers: MarketingPageContent = {
  ...
  "eyebrow": "Solutions · Trucking companies & fleets",
  "title": "Run your trucking company on Prevayl.",
  "goldTitle": true,
  "lead": "A transportation management system (TMS) for the business behind every truck. Bring dispatch, drivers, fleet operations, live tracking, accounting and driver reconciliation into one operating workflow.",
  ...
  "secondaryCta": {
    "label": "Explore the carrier TMS",
    "href": "/platform/carriers"
  },
  "sections": [
    {
      "heading": "Your company. Your customers. Your fleet.",
    ...
    {
      "heading": "OEM freight belongs in the same operation.",
    ...
    {
      "heading": "Close the load. Reconcile the driver. Know the money.",
    ...
    {
      "heading": "A working day, from dispatch to settlement.",
      "bullets": [
        "Bring in an order from a customer, broker or configured integration",
        "Plan the load and assign the truck, trailer and driver",
        "Follow tracking updates and collect pickup and delivery evidence",
        "Prepare customer billing and review driver pay and expenses",
        "Reconcile settlements and review the financial result"
      ]
    }
  ],
  "finalCta": {
