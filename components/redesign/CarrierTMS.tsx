...
export function CarrierTMS({embedded=false}:{embedded?:boolean}) {
 return <section className={embedded?"lane-carrier-product":"pvl-section pvl-wrap"} id="trucking-company-tms" aria-labelledby="carrier-tms-title">
 ...
 <CarrierScreens/>
 <div className="pvl-actions"><Link className="pvl-button" href="/solutions/carriers">Explore trucking company software ↗</Link><Link className="pvl-text-link" href="/contact?type=demo&role=carriers">Book a fleet operations demo →</Link></div>
 </section>;
}
