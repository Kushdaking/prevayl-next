...
type Props={src:string; title:string; caption?:string; eager?:boolean; disclosure?:string};
export function Screen({src,title,caption,eager=false,disclosure}:Props){
