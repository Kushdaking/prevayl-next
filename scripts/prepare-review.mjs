...
if(path.dirname(path.resolve(dest))!==path.resolve(base)||path.basename(dest)!=="dist")throw Error("Unsafe output directory");
if(fs.existsSync(dest)&&fs.lstatSync(dest).isSymbolicLink())throw Error("Output directory must not be a symlink");
